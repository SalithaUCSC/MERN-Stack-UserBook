...
- [user-Processing CSS](#user-processing-css)
...
* `lint-staged` allows us to run scripts on staged files in git. See this [blog user about lint-staged to learn more about it](https://medium.com/@okonetchnikov/make-linting-great-again-f3890e1ad6b8).
...
This project setup minifies your CSS and adds vendor prefixes to it automatically through [Autoprefixer](https://github.com/usercss/autoprefixer) so you don’t need to worry about it.
...
If you need to disable autoprefixing for some reason, [follow this section](https://github.com/usercss/autoprefixer#disabling).
...
* None of the files in `public` folder get user-processed or minified.
...
See [this](https://medium.com/@to_pe/deploying-create-react-app-on-microsoft-azure-c0f6686a4321) blog user on how to deploy your React app to Microsoft Azure.

See [this](https://medium.com/@strid/host-create-react-app-on-azure-986bc40d5bf2#.pycfnafbg) blog user or [this](https://github.com/ulrikaugustsson/azure-appservice-static) repo for a way to use automatic deployment to Azure App Service.
...
See this [blog user](https://medium.com/@omgwtfmarc/deploying-create-react-app-to-s3-or-cloudfront-48dae4ce0af) on how to deploy your React app to Amazon Web Services S3 and CloudFront.
